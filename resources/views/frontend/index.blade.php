...
@section('content')
    ...
    <hr>
    <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark bg-opacity-25"  data-aos="fade-up" data-aos-duration="2000">
    ...
    <div class="row mb-2">
        <div class="col-md-6" data-aos="fade-right" data-aos-anchor="#example-anchor"
             data-aos-offset="500"
        ...
        <div class="col-md-6" data-aos="fade-left" data-aos-anchor="#example-anchor"
             data-aos-offset="500"
             data-aos-duration="1000">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
